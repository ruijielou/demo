...
function initHtml(data) {
    var html = '<h3 class="content-title">培训课程'+ data.title +' ></h3>'
    html += '<div class="content-auther">'+ data.auther +' <span>'+ data.data +'</span></div>'
    html += '<div class="content-text the-training"><img src="images/educateDemo1.png" alt="">'+ data.content +'</div>'
    $("#noviciate-guide").html(html);
}

/*获得网址中的具体数据（paramName为你需要的参数）*/
